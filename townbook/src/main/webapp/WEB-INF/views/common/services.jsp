<script>
  ...
  app.service('eventService', [ '$rootScope', function($rootScope) {
    ...
    this.getEventStatistics = function() {
      console.log("called getEventStatistics")
      $.ajax({
        type : 'GET',
        url : '/townbook/api/statistics/event',
        dataType : 'json',
        success : function(json) {
          $rootScope.$broadcast('getEventStatisticsCompleted', json)
        }
      });
    }
